...
LABEL maintainer "ABN AMRO <@nl.abnamro.com>"
...
ARG IIB_URL=https://iwm.dhe.ibm.com/sdfdl/v2/regs2/mbford/Xa.2/Xb.WJL1CuPI9oeGhqC4Apqv5cd8v-AD_QaRncH1hx8jdJM/Xc.10.0.0.14-IIB-LINUX64-DEVELOPER.tar.gz/Xd./Xf.LPr.D1vk/Xg.9896146/Xi.swg-wmbfd/XY.regsrvs/XZ.s8xTOYJ9J1cAoQMMjMsMzeQKbvM/10.0.0.14-IIB-LINUX64-DEVELOPER.tar.gz

# Install IIB V10 Developer edition
RUN mkdir /opt/ibm && \
    curl $IIB_URL \ 
    | tar zx --exclude iib-10.0.0.14/tools --directory /opt/ibm && \
    /opt/ibm/iib-10.0.0.14/iib make registry global accept license silently
